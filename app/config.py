...
# ----------------------------
MAIL_SERVER   = os.getenv('MAIL_SERVER',   'mail.privateemail.com').strip()
MAIL_PORT     = int(os.getenv('MAIL_PORT', '587').strip())
MAIL_USE_TLS  = os.getenv('MAIL_USE_TLS',  'true').strip().lower() in ('1', 'true', 'yes')
MAIL_USERNAME = os.getenv('MAIL_USERNAME', 'admin@tiflas.com').strip()
MAIL_PASSWORD = os.getenv('MAIL_PASSWORD', '').strip()
MAIL_FROM     = os.getenv('MAIL_FROM',     MAIL_USERNAME or 'admin@tiflas.com').strip()
